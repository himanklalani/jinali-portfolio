  ...
  return (
    <main className="relative min-h-[100dvh] w-full overflow-hidden bg-[#050505]">
      ...
      <VolumetricStudio className="!min-h-[100dvh]" spots={[28, 72]} fixtureSpots={[25, 75]} isReady={isLoaded}>
        <div className="relative z-10 flex h-full flex-col px-4 md:px-12 lg:px-24 pointer-events-none pt-[35vh] md:pt-[25vh] lg:pt-[30vh]">
        ...
        <div className="mx-auto max-w-7xl px-4 md:px-12 lg:px-24">
          <div className="w-full h-[500px] md:h-[700px] relative rounded-3xl overflow-hidden border border-white/5 bg-white/[0.02] shadow-[inset_0_0_40px_rgba(255,255,255,0.02)]">
            <MediaEmbedModal items={[
              { title: "Bumble Campaign", image: "/campaigns/thumb_0.avif", link: "https://www.instagram.com/reel/DU-vpS5kxQr/", description: "View Campaign Details" },
              { title: "Swiggy Valentine's", image: "/campaigns/thumb_1.avif", link: "https://www.instagram.com/reel/DUk7vjuEtq5/", description: "View Campaign Details" },
              { title: "Swiggy Mummy Ki Maar", image: "/campaigns/thumb_2.avif", link: "https://www.instagram.com/reel/DYFMkZ2sdA3/", description: "View Campaign Details" },
              { title: "BGMI Cricket League", image: "/campaigns/thumb_3.avif", link: "https://www.instagram.com/reel/DWil3XAlFcn/", description: "View Campaign Details" },
              { title: "Clinique India", image: "/campaigns/thumb_4.avif", link: "https://www.instagram.com/reel/DItWOxQzia0/", description: "View Campaign Details" },
              { title: "Mercedes Benz x Aashna", image: "/campaigns/thumb_5.avif", link: "https://www.instagram.com/reel/DGDMFukt519/", description: "View Campaign Details" },
              { title: "Label Ritu Kumar x Lisa", image: "/campaigns/thumb_6.avif", link: "https://www.instagram.com/reel/DJPFWzVPeUG/", description: "View Campaign Details" },
              { title: "Casa Bacardi x Lisa", image: "/campaigns/thumb_7.avif", link: "https://www.instagram.com/reel/DE2YdeViksL/", description: "View Campaign Details" },
              { title: "H&M x Nykaa", image: "/campaigns/thumb_8.avif", link: "https://www.instagram.com/reel/DRBuNo0iPRl/", description: "View Campaign Details" },
              { title: "Love Beauty & Planet", image: "/campaigns/thumb_9.avif", link: "https://www.instagram.com/p/DW-zvaBIx9t/", description: "View Campaign Details" },
              ...
              { title: "India vs Pakistan", image: "/campaigns/thumb_11.avif", link: "https://www.instagram.com/p/C8CWHjVMl2w/", description: "View Campaign Details" },
              { title: "Coach x Aryaki Joon", image: "/campaigns/thumb_12.avif", link: "https://www.instagram.com/reel/Cs6NRcjBUBA", description: "View Campaign Details" },
              { title: "Dinner Party Pod", image: "/campaigns/thumb_13.avif", link: "https://www.youtube.com/@DinnerPartyPod", description: "View Campaign Details" },
              { title: "Mars x Aashna Hegde", image: "/campaigns/thumb_14.avif", link: "https://www.instagram.com/p/DNawzkpyB95/", description: "View Campaign Details" },
              { title: "Clinique x Aashna Hegde", image: "/campaigns/thumb_15.avif", link: "https://www.instagram.com/p/DBnnQSpSX4i/", description: "View Campaign Details" },
              { title: "Zara x Armaan Malik", image: "/campaigns/thumb_16.avif", link: "https://www.instagram.com/p/DDe9YhbyIgn/", description: "View Campaign Details" },
              { title: "Myntra FWD x Leisha", image: "/campaigns/thumb_17.avif", link: "https://www.instagram.com/p/CvhkTrjgfHd/", description: "View Campaign Details" },
              { title: "Koffee With Karan", image: "/campaigns/thumb_18.avif", link: "https://www.instagram.com/p/CihykNpvTrD/", description: "View Campaign Details" },
            ]} />
          </div>
        </div>
      </section>
